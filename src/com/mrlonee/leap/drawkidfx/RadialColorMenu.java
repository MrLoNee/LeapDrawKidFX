...
public class RadialColorMenu extends Group {
    ...
    private double radius1 = 160;
    private double radiusSeparator = 2;
	...
	final RadialMenuItem colorItem = RadialMenuItemBuilder.create()
		...
		.innerRadius(innerRadius).radius(radius1).build();
	...
	final RadialMenuItem colorItemExt = RadialMenuItemBuilder.create()
		...
		.innerRadius(radius1+radiusSeparator).radius(radius2).graphic(extGraphic)
		.offset(minOffset)
		.build();
	...
	final RadialMenuItem colorItemSel = RadialMenuItemBuilder.create()
		...
		.strokeVisible(false).innerRadius(radius1-10).radius(radius1-10+radiusSeparator).build();
